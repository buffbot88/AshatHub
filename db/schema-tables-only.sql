...
('cp-ashat-001', 'ASHAT Chat — AI Spec Studio', 'ashat-chat-studio',
 'Brainstorm, refine specs, and generate project files with the AI — all in the browser via Chat, with a Monaco editor and Project Files.',
 'tools', 'chat,spec,ai,editor', 'live', 142, 89, 'PHP,Vanilla JS,Monaco', NOW()),
