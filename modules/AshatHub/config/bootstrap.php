...
define('DB_ADMIN_USER', (string) ($__env('DB_ADMIN_USER') ?: ''));
define('DB_ADMIN_PASS', (string) ($__env('DB_ADMIN_PASS') ?: ''));
...
define('EMAIL_VERIFICATION_ENABLED', filter_var($__env('EMAIL_VERIFICATION_ENABLED', 'true'), FILTER_VALIDATE_BOOLEAN));
