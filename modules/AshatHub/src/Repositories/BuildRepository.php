 ...
 * (PdoBuildRepository in production), accessed via RepositoryRegistry::build().
 * Three JSON-encoded columns (phase_tree, console_logs, violations) are decoded by find().
 * ═══════════════════════════════════════════════════════════════════════
 */
