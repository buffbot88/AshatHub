    ...
    <div class="chat-pane-center flex flex-col">
      ...
      <div id="chat-messages" class="flex-1 overflow-y-auto" style="min-height: 0;">
        ...
        <div id="chat-empty-state" class="chat-empty-state">
          ...
          <p>Click "New Chat" to start building — this chat is your workspace. Brainstorm turns your idea into Spec.md + Build.md in your Project Files; when both exist, the Build tab unlocks and Omega generates the code.</p>
        </div>
      </div>
