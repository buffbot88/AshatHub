...
<section class="container mx-auto px-6 py-10">
  ...
  <div class="account-tabs" role="tablist" aria-label="Admin sections">
    ...
    <button type="button" role="tab" id="tab-hosting"   class="account-tab"        aria-selected="false" aria-controls="panel-hosting"   data-tab="hosting">Hosting</button>
  </div>
  ...
  <!-- ── Hosting ─────────────────────────────────────────────────── -->
  <div id="panel-hosting" role="tabpanel" aria-labelledby="tab-hosting" class="account-panel" hidden>
