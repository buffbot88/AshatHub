 ...
 *
 * Handles: code fences with language tags, inline code, headings,
 * bold/italic, links, unordered and ordered lists, paragraphs.
 *
 * Good enough for blog-style docs (help articles, community project
 * descriptions). Not a full CommonMark implementation — use Parsedown
 * or league/commonmark for production-grade conversion.
 *
 * Extracted from the global helpers.php md_to_html() function so the
 * rendering logic can be unit-tested independently.
 * ═══════════════════════════════════════════════════════════════════════
 */
final class MarkdownRenderer
{
     ...
     *
     * The input is HTML-escaped first, then safe HTML tags are
     * generated by the regex replacements. Link URLs are whitelisted
     * to https?://, /, and # schemes to prevent XSS.
     */
