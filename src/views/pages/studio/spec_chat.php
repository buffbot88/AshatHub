...
<section class="container mx-auto px-6 py-6">
  <div class="grid" style="grid-template-columns: 220px 1fr 280px; gap: 0; height: calc(100vh - 7rem); border-radius: var(--gold-radius-xl); overflow: hidden; border: 1px solid var(--gold-line);">
    ...
    <div class="flex flex-col" style="border-right: 1px solid var(--gold-line); background: rgba(10, 10, 10, 0.2);">
      ...
      <div class="px-6 py-4 flex items-center justify-between" style="border-bottom: 1px solid var(--gold-line);">
        <div id="chat-header-info">
          ...
          <p class="text-[10px] font-mono" style="color: var(--gold-muted);">Brainstorm · Plan · Craft specs with BrainStem</p>
        </div>
